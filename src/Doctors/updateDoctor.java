...
public class updateDoctor extends javax.swing.JFrame {
    ...
    public void loadData() {
        ...
        String sql = "select count,date,id,name,age,gender,blood,dept,phone,email,address,room,username,password from doctor";
        try {
    ...
    private void jLabel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MouseClicked
        connection = Connector.ConnectDb();
        String sql = "Update doctor set date = '" + date + "', id = '" + id + "', name = '" + name + "', age = '" + age + "', gender = '" + gender + "', blood = '" + blood + "', dept = '" + dept + "', phone = '" + phone + "', email = '" + email + "',  address = '" + address + "', room = '" + room + "', username = '" + username + "', password = '" + password + "' where count = '" + count + "'";
        try {
            ps = connection.prepareStatement(sql);
            ps.execute();
